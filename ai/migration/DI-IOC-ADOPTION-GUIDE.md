...
複製樣板至目標專案：
```powershell
Copy-Item .\ai\migration\templates\di-ioc-inventory-script.template.ps1 `
...
1. **生成問題釐清文件**：
   複製 [ai/migration/templates/di-ioc-clarification-template.md](ai/migration/templates/di-ioc-clarification-template.md)  
   填入待釐清的項目
...
- [migration.di-ioc-adoption Skill](../skills/migration.di-ioc-adoption.skill.md)
- [migration.adopt-di-ioc Prompt](../prompts/migration.adopt-di-ioc.prompt.md)
- [code.migration-conventions Instruction](../../code/instructions/code.migration-conventions.instructions.md)
...
若遇到問題或需要改進建議，請：
1. 在 `/migration.adopt-di-ioc` 或 `/migration.di-ioc-adoption` 中詳細描述問題
2. 附上實際盤點結果與錯誤訊息
